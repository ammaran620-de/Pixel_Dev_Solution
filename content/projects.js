export const projects = [
  {
    ...
    problemType: "Surface defect",
    clientType: "Tier-2 automotive supplier",
    region: "Punjab, PK",
    throughput: "240 units/min",
    deployment: "Edge (Jetson Orin NX)",
    year: "2024",
    duration: "8 weeks",
    clip: "/clips/magic-8s.mp4",
    clipCaption: "Solder bridge detection at line speed",
  ...
  },
  {
    ...
    industry: "Textile",
    problemType: "Counting and dimensioning",
    clientType: "Global apparel distributor",
    region: "Vietnam",
    throughput: "12,000 units/hr",
    deployment: "Edge (Jetson AGX Orin)",
    year: "2023",
    duration: "5 weeks",
    clip: "/clips/tshirt-8s.mp4",
    clipCaption: "DeepSORT tracking on garments",
    ...
    metric: "12,000/hr",
    outcomes: [
      { label: "Count accuracy", value: "99.9%" },
      { label: "False positive rate", value: "0.1%" },
      { label: "Inference latency", value: "22 ms" },
    ],
  ...
  },
  {
    ...
    industry: "Logistics",
    problemType: "Zone and safety monitoring",
    clientType: "3PL Warehouse Provider",
    region: "Texas, US",
    throughput: "24 bays",
    ...
    clipCaption: "Forklift and pallet tracking",
    ...
    metric: "40% faster",
    outcomes: [
      { label: "Dock throughput increase", value: "40%" },
